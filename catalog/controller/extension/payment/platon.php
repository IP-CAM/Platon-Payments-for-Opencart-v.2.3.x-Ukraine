...
class ControllerextensionPaymentPlaton extends Controller {
    ...
    public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . 'extension/payment/platon.tpl')) {
			$template = $this->config->get('config_template') . 'extension/payment/platon.tpl';
        } else {
			$template = 'extension/payment/platon.tpl';
        }
